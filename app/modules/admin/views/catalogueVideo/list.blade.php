		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<ul class="list-inline btn-special">
					<li><a class="btn btn-info tooltipElement" data-toggle="tooltip" data-placement="top" data-original-title="Add" href="{{ URL::route('catalogueVideo.modify') }}"><i class="fa fa-plus"></i></a></li>
