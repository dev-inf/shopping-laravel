<?php
 ...
 /* $Id: imdb_person.class.php 644 2014-01-25 20:20:39Z izzy $ */
  ...
  * @version $Revision: 644 $ $Date: 2014-01-25 21:20:39 +0100 (Sa, 25. Jan 2014) $
  */
 ...
 #-----------------------------------------------------------[ Constructor ]---
  ...
  function __construct($id) {
    ...
    $this->revision = preg_replace('|^.*?(\d+).*$|','$1','$Revision: 644 $');
    $this->setid($id);
  }
