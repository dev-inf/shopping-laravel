...
@section('title','Modify Catalogue of Video')
@section('content')
	<div class="col-lg-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				{{ Form::model($catalogueVideo, array('url' => URL::route('catalogueVideo.modify', array('id' => $id)), 'method' => 'post', 'role' => 'form', 'class' => 'form-horizontal')) }}
