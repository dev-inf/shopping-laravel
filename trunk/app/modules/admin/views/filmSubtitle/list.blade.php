...
@section('title','Subtitle of Film Manager')
@section('content')
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				List Subtitle of Film
			</div>
			<!-- /.panel-heading -->
			<div class="panel-body">
				<ul class="list-inline btn-special">
					<li><a class="btn btn-info tooltipElement" data-toggle="tooltip" data-placement="top" data-original-title="Add" href="{{ URL::route('filmSubtitle.modify') }}"><i class="fa fa-plus"></i></a></li>
				...
				<div class="table-responsive">
					<table id="filmSubtitle" class="table table-striped table-bordered table-hover" data-pagelength="10">
						<thead>
							<tr>
								...
								<th data-data="language">Languague</th>
