		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<ul class="list-inline btn-special">
					<li><a class="btn btn-info tooltipElement" data-toggle="tooltip" data-placement="top" data-original-title="Add" href="{{ URL::route('pages.modify') }}"><i class="fa fa-plus"></i></a></li>
        ...
        {{ View::make('admin::partials.filter', array(
        	'items' => array(
				...
				<div class="table-responsive">
					<table id="pages" class="table table-striped table-bordered table-hover" data-pagelength="10">
						<thead>
							<tr>
