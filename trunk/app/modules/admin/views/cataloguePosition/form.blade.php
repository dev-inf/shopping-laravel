...
@section('title','Modify Catalogue of Position')
@section('content')
	<div class="col-lg-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				{{ Form::model($cataloguePosition, array('url' => URL::route('cataloguePosition.modify', array('id' => $id)), 'method' => 'post', 'role' => 'form', 'class' => 'form-horizontal')) }}
